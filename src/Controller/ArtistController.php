...
class ArtistController extends AbstractController
{
     ...
     */
    public function index(ArtistRepository $artistRepository, PartnerRepository $partnerRepository): Response
    {
     ...
     */
    public function show(Artist $artist, PartnerRepository $partnerRepository): Response
    {
     ...
     */
    public function edit(Request $request, Artist $artist, PartnerRepository $partnerRepository): Response
    {
        $form = $this->createForm(ArtistType::class, $artist);
        $form->handleRequest($request);
